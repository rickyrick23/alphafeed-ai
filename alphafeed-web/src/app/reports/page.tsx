...
export default function ReportsPage() {
  ...
  const downloadReport = (name: string) => {
    // In a real app, this would fetch a URL. 
    // Here we create a dummy file to prove functionality.
    const element = document.createElement("a");
    const file = new Blob(["AlphaFeed AI Analysis Report\n\n- Market Trend: BULLISH\n- Top Pick: NVDA\n- Risk Score: LOW"], {type: 'text/plain'});
