                ...
                {result && !loading && (
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 animate-in zoom-in-95 duration-500">
                        ...
                        <div className="md:col-span-4 bg-[#161b22] border border-[#30363d] rounded-xl p-8 flex flex-col items-center justify-center relative shadow-2xl">
                            ...
                            <div className={`mt-6 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wider ${result.score >= 80 ? "bg-[#d2fc52]/10 text-[#d2fc52]" : result.score >= 50 ? "bg-yellow-500/10 text-yellow-500" : "bg-red-500/10 text-red-500"
                                }`}>
                        ...
                        <div className="md:col-span-8 space-y-4">
                            ...
                            {/* 2. Detailed Analysis */}
                            <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-6 shadow-xl">
                                <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4">DETAILED ANALYSIS</h3>
                                <div className="prose prose-invert prose-sm max-w-none text-gray-300">
                                    <div dangerouslySetInnerHTML={{ __html: result.detailedAnalysis?.replace(/\n/g, '<br/>') || "No detailed analysis available." }} />
                                </div>
                            </div>

                            {/* 3. Bias Analysis */}
                            <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-6 shadow-xl">
                                <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4">BIAS DETECTION</h3>
                                <p className="text-sm text-gray-300 leading-relaxed">
                                    {result.biasAnalysis || "No bias analysis available."}
                                </p>
                            </div>

                            {/* 4. Source Database Cross-Check */}
                            <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-6 shadow-xl">
